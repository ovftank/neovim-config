...
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\App Paths\cmd.exe" /ve /d "C:\Users\%USERNAME%\scoop\apps\windows-terminal\current\wt.exe" /f
